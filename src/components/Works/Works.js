    ...
    return (
        <div className='main mainwrapper'>
            ...
            <div/>
                ...
                <iframe width={isMobile?window.innerWidth:window.innerWidth*0.6} height={isMobile?window.innerHeight*0.5:window.innerWidth*0.3}  src="https://www.youtube.com/embed/LQB04hh9M1c" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
